...
void testGarage()
{
    ...
    printf("\nBasic garage test completed. All memory freed.\n");
}
...
void testErrorHandling() {
    ...
    if (result == garage) {
        scanf("Successfully returned original garage for out of bounds index.\n");
    }
...
void testMultipleVehicles() {
    ...
    // Display initial garage
    printf("Initial garage contents:\n");
    displayGarage(garage, numVehicles);
    
    // Remove the middle vehicle
    printf("\nRemoving the Toyota Camry...\n");
    garage = removeVehicle(garage, numVehicles, 1);
    numVehicles--;
...
int main() {
    ...
    switch (choice) {
        ...
        case 6:
            ...
            break;
        default:
            printf("Invalid choice. Running basic test only.\n");
            testGarage();
    }
